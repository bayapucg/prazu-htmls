			...
			<form>
				 <fieldset class="scheduler-border">
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="firstName" placeholder="Enter Restaurant ID" />
						</div>
					</div>
					<div class="form-group col-md-6">
					...
					<div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" class="form-control" name="firstName" placeholder="Enter Number Of Tables" />
						</div>
					</div>
					<div class="form-group col-md-6">
						<label class="">Payment</label>
						<div class="">
							<input type="text" class="form-control" name="firstName" placeholder="Enter Payment" />
						</div>
					</div>
					<div class="form-group col-md-6">
